Feature: User Creation
    ...
    Scenario: Create a new user with missing required fields
        ...
        Then the API should return a OK status code and an error message indicating that the required fields are missing
    ...
    Scenario: Create a new user with invalid data
        ...
        Then the API should return a OK status code and an error message indicating that the data is invalid
    ...
    Scenario: Create a new user with an existing email account
        ...
        Then the API should return a OK status code and an error message indicating that an account with the email provided already exists